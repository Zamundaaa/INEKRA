...
public class OBJFileLoader {
	...
	private static final String RES_LOC_OBJ = "res/obj/";

	public static ModelData loadOBJ(String objFileName) {
		InputStreamReader isr = new InputStreamReader(
				OBJFileLoader.class.getClassLoader().getResourceAsStream(RES_LOC_OBJ + objFileName + ".obj"));
		...
		try {
			...
			Err.err.println("Error reading the file " + objFileName);
		}
