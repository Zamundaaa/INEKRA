...
public class WaterFrameBuffers {
	...
	protected static int REFLECTION_WIDTH = (int) (DisplayManager.WIDTH * 0.5f);
	private static int REFLECTION_HEIGHT = (int) (DisplayManager.HEIGHT * 0.5f);

	protected static int REFRACTION_WIDTH = DisplayManager.WIDTH;
	private static int REFRACTION_HEIGHT = DisplayManager.HEIGHT;

	public static void setSizesNew() {
		REFLECTION_WIDTH = (int) (DisplayManager.WIDTH * 0.5f);
		REFLECTION_HEIGHT = (int) (DisplayManager.HEIGHT * 0.5f);
		REFRACTION_WIDTH = DisplayManager.WIDTH;
		REFRACTION_HEIGHT = DisplayManager.HEIGHT;
	}
